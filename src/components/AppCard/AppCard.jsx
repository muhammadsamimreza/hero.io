...
const AppCard = ({app}) => {
  ...
  return (
    <Link to={`/appdetails/${id}`}>
      <div className="w-60 h-72 bg-white border rounded-lg p-3 hover:scale-105 transition transform">
        ...
        <div className="my-4 space-y-2">
          ...
          <div className="flex justify-between">
            <p className="flex gap-2 items-center bg-green-50 px-3 py-1 font-bold rounded-xl text-green-600">
